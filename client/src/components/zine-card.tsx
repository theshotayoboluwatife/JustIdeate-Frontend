...
export function ZineCard({ zine, onExpand }: ZineCardProps) {
  ...
  return (
    <div>
      <motion.div
        className="masonry-item bg-background rounded-lg overflow-hidden group cursor-pointer border border-border relative"
      ...
      >
        <div className="relative">
          ...
          {/* Hover Overlay with Title and Creator Info */}
          <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/80 via-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-15">
            <div className="p-4">
              <h3 className="font-heading font-bold text-white text-base mb-2 leading-tight line-clamp-2">
                {zine.title}
              </h3>
                ...
                <div className="flex items-center space-x-3 flex-1">
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="font-semibold text-white text-sm hover:text-gray-200 transition-colors truncate">
                    ...
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        <Button
                          variant="ghost"
                          size="sm"
                          className="h-6 w-6 p-0 text-white hover:text-gray-200 hover:bg-white/20"
